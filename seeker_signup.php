          ...
          <div class="form-top">
            <div class="form-left">
              ...
              <div>
                ...
                <input class="form-control" type="date" id="dob" min="1960-01-01" max="2030-12-31" name="dob" placeholder="Date Of Birth *" value="" onchange="return calAge();" required>
              </div>
              <div>
          ...
          <div class="form-bottom">
            <div class="form-left">
              <div>
                ...
                <input class="form-control" type="date" id="passingyear" max="2030-12-31" name="passingyear" placeholder="Passing Year *" required>
              </div>
              <div>
