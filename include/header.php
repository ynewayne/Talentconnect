...
<div id='wrap'>
    ...
    <div class="topnav">
      <div class="topnav-left">
        <a href="index.php" class="active">Graduate Job Portal</a>
      </div>
      <div class="topnav-right" id="myTopnav">
        ...
        <a href = "admin/admin_login.php" style = "background-color: #fa7aff; border-radius: 10px;" >Admin</a> 
    ...
    <div id='main'>
      ...
      <h1 id="dream" >Your Dream&emsp;</h1>
